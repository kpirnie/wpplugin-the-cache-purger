...
class Results implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $fastlyFormats = [
        ...
        'tls_handshake_sent_bytes' => 'int64',
    ...
    protected static $setters = [
        ...
        'tls_handshake_sent_bytes' => 'setTlsHandshakeSentBytes',
    ...
    protected static $getters = [
        ...
        'tls_handshake_sent_bytes' => 'getTlsHandshakeSentBytes',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['hit_ratio'] = $data['hit_ratio'] ?? null;
        ...
        $this->container['pipe'] = $data['pipe'] ?? null;
        ...
        $this->container['tls_handshake_sent_bytes'] = $data['tls_handshake_sent_bytes'] ?? null;
    ...
    {
        return $this->container['hit_ratio'];
    }

    /**
     * Sets hit_ratio
     *
     * @param float|null $hit_ratio Ratio of cache hits to cache misses (between 0 and 1).
     *
     * @return self
     */
    public function setHitRatio($hit_ratio)
    {
        $this->container['hit_ratio'] = $hit_ratio;
     ...
     * Sets pipe
     *
     * @param int|null $pipe Optional. Pipe operations performed (legacy feature).
     *
     * @return self
     */
     ...
     * Sets recv_sub_time
     *
     * @param float|null $recv_sub_time Time spent inside the `vcl_recv` Varnish subroutine (in seconds).
     *
     * @return self
     */
     ...
     * Sets hash_sub_time
     *
     * @param float|null $hash_sub_time Time spent inside the `vcl_hash` Varnish subroutine (in seconds).
     *
     * @return self
     */
     ...
     * Sets miss_sub_time
     *
     * @param float|null $miss_sub_time Time spent inside the `vcl_miss` Varnish subroutine (in seconds).
     *
     * @return self
     */
     ...
     * Sets fetch_sub_time
     *
     * @param float|null $fetch_sub_time Time spent inside the `vcl_fetch` Varnish subroutine (in seconds).
     *
     * @return self
     */
     ...
     * Sets pass_sub_time
     *
     * @param float|null $pass_sub_time Time spent inside the `vcl_pass` Varnish subroutine (in seconds).
     *
     * @return self
     */
     ...
     * Sets pipe_sub_time
     *
     * @param float|null $pipe_sub_time Time spent inside the `vcl_pipe` Varnish subroutine (in seconds).
     *
     * @return self
     */
     ...
     *
     * @param float|null $deliver_sub_time Time spent inside the `vcl_deliver` Varnish subroutine (in seconds).
     *
     * @return self
     */
     ...
     * Sets error_sub_time
     *
     * @param float|null $error_sub_time Time spent inside the `vcl_error` Varnish subroutine (in seconds).
     *
     * @return self
     */
     ...
     * Sets hit_sub_time
     *
     * @param float|null $hit_sub_time Time spent inside the `vcl_hit` Varnish subroutine (in seconds).
     *
     * @return self
     */
     ...
     *
     * @param float|null $prehash_sub_time Time spent inside the `vcl_prehash` Varnish subroutine (in seconds).
     *
     * @return self
     */
     ...
     *
     * @param float|null $predeliver_sub_time Time spent inside the `vcl_predeliver` Varnish subroutine (in seconds).
     *
     * @return self
     */
    ...
    /**
     * Gets tls_handshake_sent_bytes
     *
     * @return int|null
     */
    public function getTlsHandshakeSentBytes()
    {
        return $this->container['tls_handshake_sent_bytes'];
    }

    /**
     * Sets tls_handshake_sent_bytes
     *
     * @param int|null $tls_handshake_sent_bytes Number of bytes transferred during TLS handshake.
     *
     * @return self
     */
    public function setTlsHandshakeSentBytes($tls_handshake_sent_bytes)
    {
        $this->container['tls_handshake_sent_bytes'] = $tls_handshake_sent_bytes;
