...
class Page implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'page';
     ...
     * Sets id
     *
     * @param string|null $id Unique page identifier
     *
     * @return self
     */
     ...
     * Sets website_id
     *
     * @param string|null $website_id Parent website ID
     *
     * @return self
     */
     ...
     * Sets notifications
     *
     * @param \Fastly\Model\Notification[]|null $notifications Notification configurations for this page
     *
     * @return self
     */
     ...
     * Sets paths
     *
     * @param string[]|null $paths URL paths to monitor
     *
     * @return self
     */
