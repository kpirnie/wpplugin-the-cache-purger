...
/**
 * PaginationMeta1 Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class PaginationMeta1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'pagination_meta_1';
    ...
    public function setPerPage($per_page)
    {
        ...
        if (!is_null($per_page) && ($per_page > 100)) {
            throw new \InvalidArgumentException('invalid value for $per_page when calling PaginationMeta1., must be smaller than or equal to 100.');
        }
        if (!is_null($per_page) && ($per_page < 1)) {
            throw new \InvalidArgumentException('invalid value for $per_page when calling PaginationMeta1., must be bigger than or equal to 1.');
        }
