...
```php
deleteServiceAuthorization2($options): \Fastly\Model\InlineResponse20022 // Delete service authorizations
```
...
[**\Fastly\Model\InlineResponse20022**](../Model/InlineResponse20022.md)
