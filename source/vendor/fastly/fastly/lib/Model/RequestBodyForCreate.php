...
/**
 * RequestBodyForCreate Class Doc Comment
 *
 * @category Class
 * @description All attributes for creating a domain
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class RequestBodyForCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'request_body_for_create';
     ...
     * Sets fqdn
     *
     * @param string $fqdn The fully-qualified domain name for your domain. Can be created, but not updated.
     *
     * @return self
     */
