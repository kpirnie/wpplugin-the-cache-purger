...
/**
 * SuccessfulResponseAsObject Class Doc Comment
 *
 * @category Class
 * @description All attributes for a domain response
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class SuccessfulResponseAsObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'successful_response_as_object';
     ...
     * Sets id
     *
     * @param string|null $id Domain Identifier (UUID).
     *
     * @return self
     */
     ...
     * Sets fqdn
     *
     * @param string|null $fqdn The fully-qualified domain name for your domain. Can be created, but not updated.
     *
     * @return self
     */
     ...
     * Sets service_id
     *
     * @param string|null $service_id The `service_id` associated with your domain or `null` if there is no association.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A freeform descriptive note.
     *
     * @return self
     */
     ...
     * Sets activated
     *
     * @param bool|null $activated Denotes if the domain has at least one TLS activation or not.
     *
     * @return self
     */
     ...
     * Sets verified
     *
     * @param bool|null $verified Denotes that the customer has proven ownership over the domain by obtaining a Fastly-managed TLS certificate for it or by providing a their own TLS certificate from a publicly-trusted CA that includes the domain or matching wildcard.
     *
     * @return self
     */
