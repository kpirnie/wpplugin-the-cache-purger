...
/**
 * RequestBodyForUpdate Class Doc Comment
 *
 * @category Class
 * @description All attributes for updating a domain
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class RequestBodyForUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'request_body_for_update';
