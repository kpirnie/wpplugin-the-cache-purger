...
/**
 * MutualAuthenticationsResponse Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class MutualAuthenticationsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'mutual_authentications_response';
     ...
     * Gets data
     *
     * @return \Fastly\Model\MutualAuthenticationResponseData[]|null
     */
     ...
     * Sets data
     *
     * @param \Fastly\Model\MutualAuthenticationResponseData[]|null $data data
     *
     * @return self
     */
