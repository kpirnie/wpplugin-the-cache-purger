        ...
        <ul>
            <li>
                ...
                <ul>
                    ...
                    <li><?php esc_html_e('Do you want to log purge actions?  The log file will be located here:', 'the-cache-purger'); ?> <code><?php
                                                                                                                                                    esc_html_e(ABSPATH . 'wp-content/purge.log', 'the-cache-purger'); // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText 
                                                                                                                                                    ?></code></li>
                </ul>
            </li>
            <li>
