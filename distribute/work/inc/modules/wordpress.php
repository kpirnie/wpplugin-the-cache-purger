...
if (! trait_exists('WORDPRESS')) {
    ...
    trait WORDPRESS
    {
        ...
        protected function purge_wp_transients(): void
        {
            ...
            // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- transient rows are being removed; caching the removal is meaningless
